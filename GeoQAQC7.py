...
# Initialisation de l'onglet courant dans la session state
...
tab_titles = ["Type de Contrôle", "Importation des Données", "Mappage des Colonnes", "Analyse", "Export"]
...
# Affichage de l'onglet actif uniquement basé sur session state
        ...
        with control_subtabs[1]:
            ...
            if control_type == "Standards CRM":
                ...
                if st.button("Utiliser ces données d'exemple", key="use_crm_example"):
                    ...
                    change_tab(2)  # Aller directement au mappage des colonnes
        ...
        if st.session_state.data is None:
            ...
            if submit_button:
                ...
                if all(col != "-- Sélectionner une colonne --" for col in mapping_dict.values()):
                    ...
                    # Bouton pour continuer - CORRECTION IMPORTANTE ICI
                    if st.button("Continuer vers l'analyse", key="continue_to_analysis"):
                        change_tab(3)  # Utiliser la fonction de changement d'onglet
                else:
                    ...
                    if analysis_data.empty:
                        ...
                        if lower_limit is not None and upper_limit is not None:
                            ...
                            if st.button("Continuer vers l'exportation", key="continue_to_export"):
                                change_tab(4)  # Utiliser la fonction de changement d'onglet
